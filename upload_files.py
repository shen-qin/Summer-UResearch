...
completed_count = 0  # Global variable to track completed analysis count
...
async def print_completed_count_periodically():
    global completed_count
    while True:
...
async def main():
  ...
  # Start the task to print completed count periodically
  asyncio.create_task(print_completed_count_periodically())
